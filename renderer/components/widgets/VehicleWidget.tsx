  ...
  return (
    <div className="flex flex-col justify-between w-1/3">
      ...
      <div className="flex justify-center items-center h-8 w-full">
        ...
        <p className="text-white text-opacity-80 ml-6 text-center leading-4 text-sm">{telemetry.data ? Math.floor(telemetry.data.truck.fuel.range) + "km" : "n/a"}<br/>Distance</p>
      </div>
    </div>
  );
}
